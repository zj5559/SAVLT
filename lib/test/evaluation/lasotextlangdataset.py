...
class LaSOTExtLangDataset(BaseDataset):
    """
    ...
    def __init__(self,onlyNLP=False):
        ...
        self.grounding_path='/media/zj/T9/models/grounding_results/jointnlt_grounding/lasot_ext'
    ...
    def _construct_sequence(self, sequence_name):
        ...
        if self.onlyNLP:
            grounding_rect=load_text(os.path.join(self.grounding_path,class_name,sequence_name,'init_grounding.txt'),
        ...
        if self.onlyNLP:
            dataset_name='lasotextlang_onlynl'
        else:
            dataset_name='lasotextlang'
