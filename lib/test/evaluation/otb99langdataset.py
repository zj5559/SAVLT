...
class OTB99LangDataset(BaseDataset):
    ...
    def __init__(self,onlyNLP=False):
        ...
        self.grounding_path = '/media/zj/T9/models/grounding_results/jointnlt_grounding/otb99'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        if self.onlyNLP:
            grounding_rect=load_text(os.path.join(self.grounding_path,sequence_info['name'],'init_grounding.txt'),
                                     delimiter=',',dtype=np.float64)
            ground_truth_rect[init_omit,:]=grounding_rect
        ...
        if self.onlyNLP:
            dataset_name='otb99lang_onlynl'
        else:
            dataset_name='otb99lang'
        return Sequence(sequence_info['name'], frames, dataset_name, ground_truth_rect[init_omit:, :],
