...
def return_iou_boxes(boxes1, boxes2):
    """
    :param boxes1: (N, 4) (x1,y1,x2,y2)
    :param boxes2: (N, 4) (x1,y1,x2,y2)
    :return: the iou box coords, if there are no Iou area in two boxes, the box's w and h would be zero
    """
    # print(f'boxes1 shape:{boxes1}')
    # print(f'boxes2 shape:{boxes2}')
...
def giou_loss_vec(boxes1, boxes2):
    """
