...
class Tnl2k(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, vid_ids=None, split=None, data_fraction=None,
        ...
        self.seq_per_class=None

        self.dense_nlp_root='/media/zj/T9/Dataset/tracking/lang-data/lang-anno/ours/tnl2k'
    ...
    def _read_nlp(self, seq_path):
        ...
        try:
            ...
            print(f'nlp_file:{nlp_file}')
        return nlp[0][0]
    def _read_nlp_dense(self, seq_id):
        nlp_file = os.path.join(self.dense_nlp_root,self.sequence_list[seq_id]+'.txt')
        nlp = pandas.read_csv(nlp_file, dtype=str, header=None, low_memory=False,sep='|').values
        out_dict={}
        for text in nlp:
            words = text[0].split()
    ...
    def get_sequence_info(self, seq_id):
        ...
        if self.multi_modal_language and self.use_nlp:
            ...
            output['nlp'] = nlp
            nlp_dense = self._read_nlp_dense(seq_id)
            nlp_dense[0] = nlp
            output['nlp_dense'] = nlp_dense  # dense_nlp
        return output
